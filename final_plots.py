...
ax1.errorbar(q2_bin_middle, fl_predict, yerr=fl_predict_err, fmt='None', markersize=2, label='$F_L$', color='black') #to double check that the squares are in the right place
ax2.errorbar(q2_bin_middle, afb_predict, yerr=afb_predict_err, fmt='None', markersize=2, label='$A_{FB}$', color='black') #to double check that the squares are in the right place
ax1.set_ylabel('$F_L$')
